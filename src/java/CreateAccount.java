    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           try{
            ...
            email.setContent("<h1>your password is : <h1>"+pass.toString(),"text/html");
            email.addRecipient(email2);
                ...
                String line = "INSERT INTO client(Username,password,email,displayname,PhoneNumber,Age,Address) VALUES('"+username+"','"+pass.toString()+"','"+email2+"','"+displayName+"','"+phone+"','"+age+"','"+address+"')";
