    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String roomtype = request.getParameter("roomtyp");
                ...
                stmt.executeUpdate("INSERT INTO `hotel`.`rooms` (`roomtype`, `available`, `roomfacilities`, `name`, `view`, `smoking`, `size`, `parking`, `bedtype`, `price`, `breakfast`) VALUES ('"
                        + roomtype
                        + "', '"
                        + "1"
                        + "', '"
